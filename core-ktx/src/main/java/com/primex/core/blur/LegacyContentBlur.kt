...
/**
 * Applies a content blur modifier to the composable.
 *
 * This extension function creates a content blur effect by combining a RenderScript blur element
 * with the existing modifier chain. The blur effect is controlled by the specified [radius] and [factor].
 *
