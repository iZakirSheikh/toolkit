 ...
 */
private val IncreaseVerticalSemanticsBounds: Modifier = Modifier
...
private fun DrawScope.drawIndeterminateCircularIndicator(
    startAngle: Float, strokeWidth: Dp, sweep: Float, color: Color, stroke: Stroke
) {
...
/**
 * [Determinate Material Design linear progress indicator](https://m3.material.io/components/progress-indicators/overview)
 *
 ...
 * @param backgroundColor color of the track behind the indicator, visible when the progress has not
...
fun LinearProgressIndicator(
    ...
    backgroundColor: Color = AppTheme.colors.background(3.dp),
...
/**
 * [Indeterminate Material Design linear progress indicator](https://m3.material.io/components/progress-indicators/overview)
 *
 * Progress indicators express an unspecified wait time or display the duration of a process.
 *
 * [Linear progress indicator image](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flqdiyyvh-1P-progress-indicator-configurations.png?alt=media)
...
fun LinearProgressIndicator(
    ...
    // width.
    val firstLineHead by infiniteTransition.animateFloat(0f,
        1f,
    ...
    val firstLineTail by infiniteTransition.animateFloat(0f,
        1f,
        infiniteRepeatable(animation = keyframes {
            durationMillis = LinearAnimationDuration
    ...
    val secondLineHead by infiniteTransition.animateFloat(0f,
        1f,
        infiniteRepeatable(animation = keyframes {
            durationMillis = LinearAnimationDuration
    ...
    val secondLineTail by infiniteTransition.animateFloat(0f,
        1f,
        infiniteRepeatable(animation = keyframes {
            durationMillis = LinearAnimationDuration
...
/**
 * [Determinate Material Design circular progress indicator](https://m3.material.io/components/progress-indicators/overview)
 *
 * Progress indicators express an unspecified wait time or display the duration of a process.
 *
...
/**
 * [Indeterminate Material Design circular progress indicator](https://m3.material.io/components/progress-indicators/overview)
 *
 * Progress indicators express an unspecified wait time or display the duration of a process.
 *
 * ![Circular progress indicator image](https://firebasestorage.googleapis.com/v0/b/design-spec/o/projects%2Fgoogle-material-3%2Fimages%2Flqdiyyvh-1P-progress-indicator-configurations.png?alt=media)
...
fun CircularProgressIndicator(
    ...
    val currentRotation by transition.animateValue(
        0, RotationsPerCycle, Int.VectorConverter, infiniteRepeatable(
            animation = tween(
                durationMillis = RotationDuration * RotationsPerCycle, easing = LinearEasing
            )
        )
    )
    // How far forward (degrees) the base point should be from the start point
    val baseRotation by transition.animateFloat(
        0f, BaseRotationAngle, infiniteRepeatable(
    ...
    val endAngle by transition.animateFloat(0f,
        JumpRotationAngle,
        infiniteRepeatable(animation = keyframes {
    ...
    val startAngle by transition.animateFloat(0f,
        JumpRotationAngle,
        infiniteRepeatable(animation = keyframes {
            durationMillis = HeadAndTailAnimationDuration + HeadAndTailDelayDuration
