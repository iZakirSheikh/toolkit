...
// Material 2 was chosen due to the current instability and ongoing development of Material 3.
// =================================================================================================
 ...
 */
// Note: Removed returning state from functions because it is unnecessary, as Material 3 does not
// follow this pattern.
@Stable
...
object ButtonDefaults {
    ...
    fun buttonColors(
        ...
        disabledBackgroundColor: Color = AppTheme.colors.onBackground.copy(alpha = 0.12f)
            .compositeOver(AppTheme.colors.background),
        disabledContentColor: Color = AppTheme.colors.onBackground.copy(alpha = ContentAlpha.disabled)
    ...
    /**
     * Represents the colors of an elevated button.
     */
    @Composable
    fun filledTonalButtonColors(
        backgroundColor: Color = AppTheme.colors.background(2.dp),
    ...
    val outlinedBorder: BorderStroke
        @Composable get() = BorderStroke(
            OutlinedBorderSize, AppTheme.colors.onBackground.copy(alpha = OutlinedBorderOpacity)
        )
 ...
 *   states. This controls the size of the shadow below the button. See [ButtonElevation.elevation].
...
fun Button(
    ...
    Surface(
        ...
        ProvideTextStyle(value = AppTheme.typography.label1) {
            Row(
                Modifier
                    .defaultMinSize(
