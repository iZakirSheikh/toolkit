...
object TextFieldDefaults {
    ...
    fun textFieldColors(
        ...
        focusedIndicatorColor: Color = AppTheme.colors.accent.copy(alpha = ContentAlpha.high),
        unfocusedIndicatorColor: Color =
            AppTheme.colors.onBackground.copy(alpha = UnfocusedIndicatorLineOpacity),
        disabledIndicatorColor: Color = unfocusedIndicatorColor.copy(alpha = ContentAlpha.disabled),
        errorIndicatorColor: Color = AppTheme.colors.error,
        leadingIconColor: Color = AppTheme.colors.onBackground.copy(alpha = IconOpacity),
        disabledLeadingIconColor: Color = leadingIconColor.copy(alpha = ContentAlpha.disabled),
        errorLeadingIconColor: Color = leadingIconColor,
        trailingIconColor: Color = AppTheme.colors.onBackground.copy(alpha = IconOpacity),
        disabledTrailingIconColor: Color = trailingIconColor.copy(alpha = ContentAlpha.disabled),
        errorTrailingIconColor: Color = AppTheme.colors.error,
        focusedLabelColor: Color = AppTheme.colors.accent.copy(alpha = ContentAlpha.high),
        unfocusedLabelColor: Color = AppTheme.colors.onBackground.copy(ContentAlpha.medium),
        disabledLabelColor: Color = unfocusedLabelColor.copy(ContentAlpha.disabled),
        errorLabelColor: Color = AppTheme.colors.error,
        placeholderColor: Color = AppTheme.colors.onBackground.copy(ContentAlpha.medium),
    ...
    fun outlinedTextFieldColors(
        ...
        cursorColor: Color = AppTheme.colors.accent,
        errorCursorColor: Color = AppTheme.colors.error,
        focusedBorderColor: Color = AppTheme.colors.accent.copy(alpha = ContentAlpha.high),
        unfocusedBorderColor: Color =
            AppTheme.colors.onBackground.copy(alpha = ContentAlpha.disabled),
