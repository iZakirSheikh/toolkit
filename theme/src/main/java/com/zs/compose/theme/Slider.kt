...
import com.zs.compose.theme.internal.awaitHorizontalPointerSlopOrCancellation
import com.zs.compose.theme.internal.pointerSlop
...
// copy of material2 slider
// just changed some variable like colors etc.
// needs to be re-implemented with new features.
...
object SliderDefaults {
    ...
    @Composable
    fun colors(
        thumbColor: Color = AppTheme.colors.accent,
        disabledThumbColor: Color =
            AppTheme.colors.onBackground
                .copy(alpha = ContentAlpha.disabled)
                .compositeOver(AppTheme.colors.background(1.dp)),
        activeTrackColor: Color = AppTheme.colors.accent,
        inactiveTrackColor: Color = activeTrackColor.copy(alpha = InactiveTrackAlpha),
        disabledActiveTrackColor: Color =
            AppTheme.colors.onBackground.copy(alpha = DisabledActiveTrackAlpha),
